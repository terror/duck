...
class LinkedList:
  def __init__(self, n=0):
    self.head = self.tail = None; self.size = 0;
    for i in range(n): self.add(Node(string.ascii_uppercase[i]))
...
def main(n, m, o, *args):
  l, r = LinkedList(n), []; s = l.get(m); i = s; a = i.key; s.key = None; i = i.next;
